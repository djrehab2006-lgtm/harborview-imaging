...
function PortfolioPage() {
  const beforeAfterSets = [
    ...
    {
      before: {
        url: "https://content-studio.biela.dev/content-studio/692aebe3b18c3df6b262e090/1764420595862-692aebe3b18c3df6b262e090/1765213267151.png",
        alt: "Before: Stock product photo of gold and silver chain link necklace with pink clover pendant"
      },
      after: {
        url: "https://content-studio.biela.dev/content-studio/692aebe3b18c3df6b262e090/1764420595862-692aebe3b18c3df6b262e090/1765213267142.jpeg",
        alt: "After: HD lifestyle shot of chain link necklace with clover pendant worn by woman with natural lighting"
      }
    }
  ];

  return (
    <div id="portfolio_page" className="min-h-screen bg-white pt-16">
