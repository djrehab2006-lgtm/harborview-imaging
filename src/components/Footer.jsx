      ...
      <div className="mx-auto max-w-7xl px-6 py-12 lg:px-8">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 mb-8">
          <div>
            <div className="mb-4">
              <img 
                src="https://content-studio.biela.dev/content-studio/692aebe3b18c3df6b262e090/1764420595862-692aebe3b18c3df6b262e090/1765212863509.png?search_term=harborview,imaging,co,logo,white" 
                alt="Harborview Imaging Co. Logo" 
                className="max-h-[432px] w-auto object-contain"
              />
            </div>
